...
import io.github.nianliu.archimedes.example.model.CreateUserRequest;
import io.github.nianliu.archimedes.example.model.UserResponse;
...
public class UserController {
    ...
    public UserResponse createUser(@RequestBody CreateUserRequest request) {
        return new UserResponse(100L, request.username(), request.email());
    }
